...
export default function Panel({ title, kicker, children, className = '' }: PanelProps) {
  return (
    <section
      className={[
        'rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(8,10,19,0.9))] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur',
        className,
      ].join(' ')}
    >
      {(title || kicker) && (
